...
public class Commoncharadd {
	void CommonCharacteradd(String s1, String s2) {
		...
		System.out.println("Common character " + commonChars);
	}

	public static void main(String[] args) {
		// TODO Auto-generated method stub
		Commoncharadd commonCharacter = new Commoncharadd();
		commonCharacter.CommonCharacteradd("abcfgh", "aasdf");
	}
